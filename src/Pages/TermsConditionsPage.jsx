    ...
    <>
      ...
      <article className="privacy-policy-container">
        ...
        <section className="privacy-policy-section">
          ...
          <p>
            We are ChargeBay LLC ("Company," "we," "us," "our"), a company registered in Florida, United States at 3512 Diamond Leaf Court, Valrico, FL 33594.

            We operate the mobile application ChargeBay USA (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").

            ChargeBay is a one-stop EV charging solution providing hosts with functional, affordable, and reservable chargers, as well as an application to reserve and use chargers on the ChargeBay network.

            You can contact us by phone at +1 757-524-2743, email at operations@chargebay.app, or by mail to 3512 Diamond Leaf Court, Valrico, FL 33594, United States.

            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and ChargeBay LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.

            We will provide you with prior notice of any scheduled changes to the Services you are using. The modified Legal Terms will become effective upon posting or notifying you by operations@chargebay.app, as stated in the email message. By continuing to use the Services after the effective date of any changes, you agree to be bound by the modified terms.
        ...
        <section className="privacy-policy-section">
          ...
          <ol className="privacy-policy-tableOfContents">
            <li><a href="#section-1" className="privacy-policy-link">OUR SERVICES</a></li>
            <li><a href="#section-2" className="privacy-policy-link">INTELLECTUAL PROPERTY RIGHTS</a></li>
            <li><a href="#section-3" className="privacy-policy-link">USER REPRESENTATIONS</a></li>
            <li><a href="#section-4" className="privacy-policy-link">USER REGISTRATION</a></li>
            <li><a href="#section-5" className="privacy-policy-link">PURCHASES AND PAYMENT</a></li>
            <li><a href="#section-6" className="privacy-policy-link">POLICY</a></li>
            <li><a href="#section-7" className="privacy-policy-link">PROHIBITED ACTIVITIES</a></li>
            <li><a href="#section-8" className="privacy-policy-link">USER GENERATED CONTRIBUTIONS</a></li>
            <li><a href="#section-9" className="privacy-policy-link">CONTRIBUTION LICENSE</a></li>
            <li><a href="#section-10" className="privacy-policy-link">GUIDELINES FOR REVIEWS</a></li>
            <li><a href="#section-11" className="privacy-policy-link">MOBILE APPLICATION LICENSE</a></li>
            <li><a href="#section-12" className="privacy-policy-link">SOCIAL MEDIA</a></li>
            <li><a href="#section-13" className="privacy-policy-link">THIRD-PARTY WEBSITES AND CONTENT</a></li>
            <li><a href="#section-14" className="privacy-policy-link">SERVICES MANAGEMENT</a></li>
            <li><a href="#section-15" className="privacy-policy-link">PRIVACY POLICY</a></li>
            <li><a href="#section-16" className="privacy-policy-link">COPYRIGHT INFRINGEMENTS</a></li>
            <li><a href="#section-17" className="privacy-policy-link">TERM AND TERMINATION</a></li>
            <li><a href="#section-18" className="privacy-policy-link">MODIFICATIONS AND INTERRUPTIONS</a></li>
            <li><a href="#section-19" className="privacy-policy-link">GOVERNING LAW</a></li>
            <li><a href="#section-20" className="privacy-policy-link">DISPUTE RESOLUTION</a></li>
            <li><a href="#section-21" className="privacy-policy-link">CORRECTIONS</a></li>
            <li><a href="#section-22" className="privacy-policy-link">DISCLAIMER</a></li>
            <li><a href="#section-23" className="privacy-policy-link">LIMITATIONS OF LIABILITY</a></li>
            <li><a href="#section-24" className="privacy-policy-link">INDEMNIFICATION</a></li>
            <li><a href="#section-25" className="privacy-policy-link">USER DATA</a></li>
            <li><a href="#section-26" className="privacy-policy-link">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
            <li><a href="#section-27" className="privacy-policy-link">CALIFORNIA USERS AND RESIDENTS</a></li>
            <li><a href="#section-28" className="privacy-policy-link">MISCELLANEOUS</a></li>
            <li><a href="#section-29" className="privacy-policy-link">CONTACT US</a></li>
          </ol>
        </section>

        <section id="section-1" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">1. OUR SERVICES</h2>
          <p>
        ...
        <section id="section-2" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">2. INTELLECTUAL PROPERTY RIGHTS</h2>
          ...
          <p>Subject to your compliance with these Legal Terms, including the <a href="#section-7">"PROHIBITED ACTIVITIES"</a> section below, we grant you a non-exclusive, non-transferable, revocable license to:</p>
          ...
          <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: operations@chargebay.app. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
          <p>We reserve all rights not expressly granted to you in and to the Services, Content, and Marks.</p>
          <p>Any breach of these Intellectual Property Rights will constitute a material breach of our Legal Terms and your right to use our Services will terminate immediately.</p>

          <p><strong>Your submissions and contributions</strong></p>
          <p>Please review this section and the <a href="#section-7" style={{ color: 'skyblue' }}>"PROHIBITED ACTIVITIES"</a> section carefully prior to using our Services to understand the (a) rights you give us and (b) obligations you have when you post or upload any content through the Services.</p>
          ...
          <ul className="privacy-policy-list">
            <li>confirm that you have read and agree with our <a href="#section-7">"PROHIBITED ACTIVITIES"</a> and will not post, send, publish, upload, or transmit through the Services any Submission nor post any Contribution that is illegal, harassing, hateful, harmful, defamatory, obscene, bullying, abusive, discriminatory, threatening to any person or group, sexually explicit, false, inaccurate, deceitful, or misleading;</li>
          ...
          <p>We respect the intellectual property rights of others. If you believe that any material available on or through the Services infringes upon any copyright you own or control, please immediately refer to the <a href="#section-16">"COPYRIGHT INFRINGEMENTS"</a> section below.</p>
        </section>

        <section id="section-3" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">3. USER REPRESENTATIONS</h2>
        ...
        <section id="section-5" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">5. PURCHASES AND PAYMENT</h2>
          <p>We accept the following forms of payment:</p>
          <ul className="privacy-policy-list" style={{ listStyleType: 'square' }}>
            <li>Visa</li>
            <li>Mastercard</li>
        ...
        <section id="section-6" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">6. POLICY</h2>
          <p>All sales are final and no refund will be issued.</p>
        </section>

        <section id="section-7" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">7. PROHIBITED ACTIVITIES</h2>
          <p>
          ...
          <ul className="privacy-policy-list" style={{ listStyleType: 'square' }}>
            ...
            <li>
              ...
              prevent or restrict the use or copying of any Content or enforce limitations on the use of the Services and/or
            ...
            <li>
              ...
              party's uninterrupted use and enjoyment of the Services or modifies, impairs, disrupts, alters, or interferes with
        ...
        <section id="section-8" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">8. USER GENERATED CONTRIBUTIONS</h2>
          <p>
        ...
        <section id="section-9" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">9. CONTRIBUTION LICENSE</h2>
        ...
        <section id="section-10" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">10. GUIDELINES FOR REVIEWS</h2>
        ...
        <section id="section-11" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">11. MOBILE APPLICATION LICENSE</h2>
        ...
        <section id="section-12" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">12. SOCIAL MEDIA</h2>
        ...
        <section id="section-13" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">13. THIRD-PARTY WEBSITES AND CONTENT</h2>
        ...
        <section id="section-14" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">14. SERVICES MANAGEMENT</h2>
        ...
        <section id="section-15" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">15. PRIVACY POLICY</h2>
        ...
        <section id="section-16" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">16. COPYRIGHT INFRINGEMENTS</h2>
        ...
        <section id="section-17" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">17. TERM AND TERMINATION</h2>
        ...
        <section id="section-18" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">18. MODIFICATIONS AND INTERRUPTIONS</h2>
        ...
        <section id="section-19" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">19. GOVERNING LAW</h2>
        ...
        <section id="section-20" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">20. DISPUTE RESOLUTION</h2>
          ...
          <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA’s Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the American Arbitration Association (AAA) website. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Hillsborough, Florida. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.</p>
          <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Hillsborough, Florida, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</p>
          <p>In no event shall any Dispute brought by either Party related in any way to the Services be commenced more than two (2) years after the cause of action arose. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.</p>
        ...
        <section id="section-21" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">21. CORRECTIONS</h2>
          <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
        </section>

        <section id="section-22" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">22. DISCLAIMER</h2>
        ...
        <section id="section-23" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">23. LIMITATIONS OF LIABILITY</h2>
        ...
        <section id="section-24" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">24. INDEMNIFICATION</h2>
        ...
        <section id="section-25" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">25. USER DATA</h2>
          <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
        </section>

        <section id="section-26" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">26. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
        ...
        <section id="section-27" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">27. CALIFORNIA USERS AND RESIDENTS</h2>
          <p>If any complaint with us is not satisfactorily resolved, you can contact the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs in writing at 1625 North Market Blvd., Suite N 112, Sacramento, California 95834 or by telephone at (800) 952-5210 or (916) 445-1254.</p>
        </section>

        <section id="section-28" className="privacy-policy-section">
          <h2 className="privacy-policy-sectionTitle">28. MISCELLANEOUS</h2>
        ...
        <section id="section-29" className="privacy-policy-section">
          ...
          <ul className="privacy-policy-list" style={{ listStyleType: 'none', color: '#333', fontWeight: '600', paddingLeft: '0' }}>
            ...
            <li>United States</li>
            <li>Phone: +1 757-524-2743</li>
            <li>operations@chargebay.app</li>
          </ul>
        </section>
